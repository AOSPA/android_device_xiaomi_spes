...
function blob_fixup() {
    case "${1}" in
        ...
        vendor/lib64/libvendor.goodix.hardware.biometrics.fingerprint@2.1.so)
            ...
            ;;
        vendor/lib64/libanc_dc_base.so|vendor/lib64/libwa_depth.so|vendor/lib64/libwa_dof.so|vendor/lib64/libwa_refocus.so|vendor/lib64/libwa_rtdof.so|vendor/lib64/libwa_rtdof.so)
