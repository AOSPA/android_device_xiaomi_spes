...
public class DcDimmingTileService extends TileService {
    ...
    private void updateDCdimmingTile() {
        String enabled = context.getResources().getString(R.string.dc_dimming_title_enabled);
        String disabled = context.getResources().getString(R.string.dc_dimming_title_disabled);
