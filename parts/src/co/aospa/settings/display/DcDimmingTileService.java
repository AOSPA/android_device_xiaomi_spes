...
public class DCdimmingTileService extends TileService {
    ...
    private void updateDCdimmingTile() {
        String enabled = context.getResources().getString(R.string.dc_dimmin_title_enabled);
        String disabled = context.getResources().getString(R.string.dc_dimmin_title_disabled);
